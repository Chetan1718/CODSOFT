...
dot = Button(root, text=".", font=("Courier New", 16, "bold"), padx=20, pady=16, bd=4, bg="gray85",
...
mult = Button(root, text="X", font=("Courier New", 16, "bold"), padx=20, pady=16, bd=4, bg="light green",
              command=lambda: insert("*"))
mult.place(x=3 * X, y=Y + 20)

div = Button(root, text="/", font=("Courier New", 16, "bold"), padx=20, pady=16, bd=4, bg="light green",
             command=lambda: insert("/"))
div.place(x=3 * X, y=(2 * Y) + 20)

plus = Button(root, text="+", font=("Courier New", 16, "bold"), padx=20, pady=16, bd=4, bg="light green",
              command=lambda: insert("+"))
plus.place(x=3 * X, y=(3 * Y) + 20)

minus = Button(root, text="-", font=("Courier New", 16, "bold"), padx=20, pady=16, bd=4, bg="light green",
               command=lambda: insert("-"))
